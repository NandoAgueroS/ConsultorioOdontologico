            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseSecretarios"
                   aria-expanded="true" aria-controls="collapseUtilities">
                    ...
                    <span>Secretarios/as</span>
                </a>
                <div id="collapseSecretarios" class="collapse" aria-labelledby="headingUtilities"
                     data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6>
                        <a class="collapse-item" href="SvSecretarios">Ver Secretarios/as</a>
                        <a class="collapse-item" href="altaSecretarios.jsp">Alta Secretarios/as</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Utilities Collapse Menu -->
