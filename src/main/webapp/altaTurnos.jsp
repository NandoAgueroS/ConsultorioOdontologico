...
<%  String fechaTurno = (String) request.getSession().getAttribute("fechaTurno");
    System.out.println("Fecha Turno: " + fechaTurno);%>
<!-- Begin Page Content -->
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <form name="consultar_horarios_disponibles" action="SvTurnos" method="GET">
                    <table class="table table-bordered"  width="100%" cellspacing="0"><!--id="dataTable"--> <!--se lo saque para probar-->
                        <thead>
                            <tr>
                                <th>Dia</th>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <input type="date" class="form-control form-control-user" id="dia_turno" 
                                           name="dia_turno" value="<%=fechaTurno%>" >
                                </td>
                                <td style="display: flex; width: 230px;">
                                    <button type="submit" class="btn btn-primary btn-user btn-block"; style="margin-left: 5px;">
                                        <i class="fas fa-pencil-alt"></i> Consultar horarios
                                    </button>
                ...
                <form action="SvTurnos" method="POST">
                    <table class="table table-bordered"  width="100%" cellspacing="0"> <!--id="dataTable"--> <!--se lo saque para probar-->
                        ...
                        <%SimpleDateFormat formato = new SimpleDateFormat("yyyy-MM-dd");
                            ...
                            String fechasDeTurnos;
                            for (Turno turnoLista : turnosOcupados) {
                                fechasDeTurnos = formato.format(turnoLista.getFecha_turno());
                                if (fechaTurno.equals(fechasDeTurnos)) {
...
%>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="date" class="form-control form-control-user" id="dia_turno" 
                                           name="dia_turno" value="<%=fechaTurno%>" readonly>
                                </td>
